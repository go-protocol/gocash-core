...
contract GoSwapCash is ERC20Burnable, AdminRole {
    /**
     * @notice Constructs the GoSwap Cash ERC-20 contract.
     */
    constructor() public ERC20('GoSwap Cash', 'GOC') {
    ...
    /**
     * @notice Operator mints GoSwap cash to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of GoSwap cash to mint to
